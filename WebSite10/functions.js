function printSquare() {
    var num = parseFloat(prompt("please enter square side length:"));
    if (num > 50) {
        ...
        if ((num % 2) != 1 && (num % 2) != 0) {
            ...
            var shapeContent = parseInt(prompt("please select shape content:" + "\n" + "1) * * * * * " + "\n" + "2) *         * " + "\n" + "3) 1 2 3 4 5" + "\n" + "4) 5 4 3 2 1"));
...
function printRectangle() {
    var rectangleWidth = parseFloat(prompt("please enter rectangle width:"));
    if (rectangleWidth > 50) {
        ...
        if (rectangleWidth % 2 != 0 && rectangleWidth % 2 != 1) {
            ...
            var rectangleHeigth = parseFloat(prompt("please enter rectangle heigth:"));
                    ...
                    if (shapeContent != 1 && shapeContent != 2 && shapeContent != 3 && shapeContent != 4) {
                        ...
                        switch (shapeContent) {
                            case 1:
                                ...
                                break;
                            case 2:
                                for (var j = 1; j <= rectangleHeigth; j++) {
                            ...
                            case 3:
                                ...
                                break;
                            case 4:
                                for (var j = 0; j < rectangleHeigth; j++) {
...
function printTriangle() {
    var triangleLength = parseFloat(prompt("please enter triangle side length:"));
